...
class __TwigTemplate_c8550700c70f037fe8d30f1bf1503f34673f9ff2df44b9d6d9aad4f9a206644a extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
            ...
            echo "</p>
                <p>";
            // line 11
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "cover", [], "any", false, false, false, 11), "html", null, true);
            echo "</p>
                <p>Créer le : ";
            // line 12
            ((twig_get_attribute($this->env, $this->source, $context["article"], "createdAt", [], "any", false, false, false, 12)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "createdAt", [], "any", false, false, false, 12), "d/m/Y H:i:s"), "html", null, true))) : (print ("")));
            echo "</p>

                 <p><a href=\"";
            // line 14
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("showHome", ["id" => twig_get_attribute($this->env, $this->source, $context["article"], "id", [], "any", false, false, false, 14)]), "html", null, true);
...
";
    ...
    {
        return array (  123 => 17,  114 => 14,  109 => 12,  105 => 11,  101 => 10,  96 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"articles\">
    {% for article in articles %}
                ...
                <p>Créer le : {{ article.createdAt ? article.createdAt|date('d/m/Y H:i:s') : '' }}</p>
                 ...
                 <p><a href=\"{{ path('showHome', {'id': article.id}) }}\">Lire la suite</a></p> 
               
    {% endfor %}
</div>

{% endblock %}
", "front/default/home.html.twig", "/opt/lampp/htdocs/blog_symfony/templates/front/default/home.html.twig");
    }
}
