    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo "</td>
                <td>";
            // line 22
            echo ((twig_get_attribute($this->env, $this->source, $context["category"], "enabled", [], "any", false, false, false, 22)) ? ("Yes") : ("No"));
            echo "</td>
                <td>
                    <a href=\"";
            // line 24
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("category_show", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 24)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 25
            ...
            echo "\">edit</a>
                     <a href=\"";
            // line 26
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("category_change_status", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 26)]), "html", null, true);
            echo "\">
                      ";
            // line 27
            echo ((twig_get_attribute($this->env, $this->source, $context["category"], "enabled", [], "any", false, false, false, 27)) ? ("desactiver") : ("activer"));
            echo "
                    </a>
...
";
    ...
    {
        return array (  160 => 40,  155 => 37,  146 => 33,  135 => 27,  131 => 26,  127 => 25,  123 => 24,  118 => 22,  114 => 21,  110 => 20,  107 => 19,  102 => 18,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
                ...
                <td>
                    ...
                    <a href=\"{{ path('category_edit', {'id': category.id}) }}\">edit</a>
                     <a href=\"{{ path('category_change_status', {'id': category.id}) }}\">
                      {{category.enabled ? 'desactiver' : 'activer'}}
                    </a>
...
{% endblock %}
", "category/index.html.twig", "/opt/lampp/htdocs/blog_symfony/templates/category/index.html.twig");
    }
}
